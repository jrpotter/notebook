...
A **conic** is a curve obtained as the intersection of a plane (called the **cutting plane**) with the surface of a right double cone (a cone with two **nappes**).

There are three types of conics: the ellipse, the parabola, and the hyperbola. The [[ellipse]] is a special kind of ellipse, though historically it was considered a fourth type.
...
Back: A right double cone, i.e. a cone with two nappes.
Reference: _Wikipedia_. “Conic section.” June 5, 2025. [https://en.wikipedia.org/w/index.php?title=Conic_section](https://en.wikipedia.org/w/index.php?title=Conic_section&oldid=1294110447).
<!--ID: 1750377738472-->
END%%
