...
An **implicit equation** is a relation of the form $F(x_1, \ldots, x_n) = 0$, where $F$ is a [[sets/functions|function]] of several variables. For example, the implicit equation of the unit circle is $x^2 + y^2 - 1 = 0$.
