...
**Addition** is usually denoted using the $+$ symbol. This does not necessarily correspond to the standard [[arithmetic]] operation. It is generally reserved for [[operations#Commutativity|commutative operations]]. An inverse of $a$ in additive notation is typically denoted as $-a$. The identity element is typically denoted as $0$. For some $n \in \mathbb{Z}$,

* $0a$ is interpreted as the identity element
* $na$ is interpreted as $a + a + \cdots + a$, where $a$ is repeated $n$ times.
* $-na$ is interpreted as $(-a) + (-a) + \cdots + (-a)$, where $(-a)$ is repeated $n$ times.

**Multiplication** is usually denoted using the $\cdot$ symbol or the immediate juxtaposition of two elements. This does not necessarily correspond to the standard [[arithmetic]] operation. An inverse of $a$ in multiplicative notation is typically denoted as $a^{-1}$. An identity element is typically denoted as $1$. For some $n \in \mathbb{Z}$:
...
A group's **order** refers to the [[cardinality]] of its associated set. Up to [[magmas#Isomorphisms|isomorphism]]:
...
If the associated set is not finite, the group is said to have **infinite order**.
...
%%ANKI
Basic
What does it mean for a group to have infinite order?
Back: The underlying set has infinite cardinality.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775923465041-->
END%%
...
%%ANKI
Basic
Is the following true or false? If false, why?

> Every group of order $\leq 3$ is cyclic.
...
> Every group of order $\leq 4$ is cyclic.

Back: False. The Klein group $K_4$ is not cyclic.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776704601738-->
END%%
...
> Let $G_1$ and $G_2$ be groups. Then $G_1 \cap G_2$ is a group.

Back: False. $G_1 \cap G_2$ may be the empty set which cannot be a group.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776704601742-->
END%%
...
> Let $G$ be a group and $H, K \leq G$. Then $H \cap K$ is a group.
...
This group is the [[preorder#Maximums and Minimums|minimum]] subgroup of $G$ that contains $a$. An element $a$ of a group $G$ **generates** $G$ if $\langle a \rangle = G$. Alternatively, we call $a$ a **generator for** $G$. A group $G$ is **cyclic** if there is some element $a \in G$ that generates $G$.

Every cyclic group is abelian. Every subgroup of a cyclic group is cyclic. Every cyclic group of infinite order is isomorphic to $\langle \mathbb{Z}, + \rangle$. Every cyclic group of finite order $n \in \mathbb{Z}^+$ is isomorphic to $\langle \mathbb{Z}_n, +_n \rangle$.

Let $G$ be a cyclic group with $n$ elements and generator $a$. Let $b \in G$ and let $b = a^s$. Then $b$ generates a cyclic subgroup $H$ of $G$ containing $n / d$ elements, where $d$ is the [[algebra/arithmetic#Greatest Common Divisor|greatest common divisor]] of $n$ and $s$. Also, $\langle a^s \rangle = \langle a^t \rangle$ if and only if $\gcd(s, n) = \gcd(t, n)$.
...
%%ANKI
Basic
Why must every cyclic group be abelian?
Back: If the group is generated by $a$, $$a^ma^n = a^{m + n} = a^{n + m} = a^na^m.$$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775923465052-->
END%%
...
%%ANKI
Basic
Why must every abelian group be cyclic?
...
%%ANKI
Basic
Let $H$ be a nontrivial subgroup of group $\langle a \rangle$. What is the generator of $H$?
Back: $a^m \in H$ where $m \in \mathbb{Z}^+$ is the smallest such integer.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775940887363-->
END%%
...
%%ANKI
Basic
Let $G$ be a cyclic group. *Must* a subgroup of $G$ also be cyclic?
Back: Yes.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775940887372-->
END%%
...
%%ANKI
Basic
What are the subgroups of $\mathbb{Z}$ under addition?
Back: Precisely the groups $n\mathbb{Z}$ under addition, where $n \in \mathbb{Z}$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775940887375-->
END%%
...
%%ANKI
Basic
*Why* must a subgroup of $\langle \mathbb{Z}, + \rangle$ be of form $n \mathbb{Z}$ for some $n \in \mathbb{Z}$?
Back: Every subgroup of $\langle \mathbb{Z}, + \rangle$ must be cyclic.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775940887378-->
END%%
...
%%ANKI
Basic
For what value of $n \in \mathbb{Z}$ does $\langle \mathbb{Z}, + \rangle = \langle n\mathbb{Z}, + \rangle$?
Back: $n = 1$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1775940887381-->
END%%
...
%%ANKI
Basic
Let $G$ be a cyclic group of infinite order. What group must it be isomorphic to?
Back: $\langle \mathbb{Z}, + \rangle$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629834-->
END%%
...
%%ANKI
Basic
Let $G$ be a cyclic group of finite order $n \in \mathbb{Z}^+$. What group must it be isomorphic to?
Back: $\langle \mathbb{Z}_n, +_n \rangle$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629839-->
END%%
...
%%ANKI
Basic
Up to isomorphism, how many cyclic groups of infinite order are there?
Back: Just one, e.g. $\langle \mathbb{Z}, + \rangle$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629844-->
END%%
...
%%ANKI
Basic
Up to isomorphism, how many cyclic groups of finite order $n \in \mathbb{Z}^+$ are there?
Back: Just one, e.g. $\langle \mathbb{Z}_n, +_n \rangle$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629848-->
END%%
...
%%ANKI
Basic
Let $G$ be a cyclic group generated by $a$ of infinite order. What isomorphism $\phi$ exists between $G$ and $\langle \mathbb{Z}, + \rangle$?
Back: $\phi(a^m) = m$ for all $m \in \mathbb{Z}$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629852-->
END%%
...
%%ANKI
Basic
Let $G$ be a cyclic group generated by $a$ of finite order $n \in \mathbb{Z}^+$. What isomorphism $\phi$ exists between $G$ and $\langle \mathbb{Z}_n, +_n \rangle$?
Back: $\phi(a^m) = m$ for all $m \in \mathbb{Z}_n$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776188629856-->
END%%
...
%%ANKI
Basic
Consider finite group $\langle a \rangle$ of order $n$. What is the order of $\langle a^s \rangle$ for some $s \in \mathbb{Z}^+$?
Back: $n / d$ where $d = \gcd(n, s)$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776444992630-->
END%%
...
%%ANKI
Basic
Consider finite group $\langle a \rangle$ of order $n$. What is the order of $\langle a^t \rangle$ in terms of $\gcd$?
Back: $n \div \gcd(n, t)$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776444992632-->
END%%
...
%%ANKI
Basic
Consider finite group $\langle a \rangle$ of order $n$. What is the order of $\langle a^t \rangle$ in terms of $\mathop{\text{lcm}}$?
Back: $\mathop{\text{lcm}}(n, t) \div t$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776444992634-->
END%%
...
%%ANKI
Basic
Consider finite group $\langle a \rangle$ of order $n$. Then $\langle a^s \rangle = \langle a^t \rangle$ if and only if what equality holds?
Back: $\gcd(n, s) = \gcd(n, t)$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776444992635-->
END%%
...
%%ANKI
Basic
Consider finite group $\langle a \rangle$ of order $n$. *Why* does the following biconditional hold? $$\langle a^s \rangle = \langle a^t \rangle \iff \gcd(n, s) = \gcd(n, t)$$
Back: There is only one cyclic group, up to isomorphism, of order $n \div \gcd(n, s)$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776444992637-->
END%%
...
%%ANKI
Basic
Consider group $\langle \mathbb{Z}_{12}, +_{12} \rangle$. What is the order of subgroup $\langle 3 \rangle$?
Back: $$\frac{12}{\gcd(3, 12)} = \frac{12}{3} = 4$$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776459508502-->
END%%
...
%%ANKI
Basic
Consider group $\langle \mathbb{Z}_{7}, +_{7} \rangle$. What is the order of subgroup $\langle 3 \rangle$?
Back: $$\frac{7}{\gcd(3, 7)} = \frac{7}{1} = 7$$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776459508506-->
END%%
...
%%ANKI
Basic
Let $a$ be a generator of finite cyclic group $G$ of order $n$. What are the other generators of $G$?
Back: $a^r$ where $r$ is relatively prime to $n$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776459508508-->
END%%
...
%%ANKI
Basic
How many solutions are there to equation $mx \equiv 0 \pmod{n}$?
Back: $\gcd(m, n)$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776914254202-->
END%%
...
%%ANKI
Basic
Let $G$ be a finite cyclic group with identity $e$. How many solutions are there to $x^m = e$?
Back: Suppose $g$ has order $n$. Then there are $\gcd(m, n)$ solutions.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776914254207-->
END%%
...
%%ANKI
Basic
Let $G$ be a finite cyclic group with order $n$ and identity $e$. If $m \mid n$, how many solutions are there to $x^m = e$?
Back: $m$
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776914254212-->
END%%
...
%%ANKI
Basic
When are there $m$ solutions to equation $mx \equiv 0 \pmod{n}$?
Back: When $m$ divides $n$, i.e. $\gcd(m, n) = m$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776914254216-->
END%%
...
%%ANKI
Basic
When are there fewer than $m$ solutions to equation $mx \equiv 0 \pmod{n}$?
Back: When $m$ does not divide $n$, i.e. $\gcd(m, n) \neq m$.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776914254221-->
END%%
...
%%ANKI
Basic
How does a group relate to its cyclic subgroups?
Back: Every group is the union of its cyclic subgroups.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776962577512-->
END%%
...
%%ANKI
Basic
*Why* must a group be equal to the union of its cyclic subgroups?
Back: Every element of a group forms a cyclic subgroup containing itself.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776962577515-->
END%%
...
%%ANKI
Basic
In what way are cyclic groups more "fundamental" than groups in general?
Back: Every group is the union of its cyclic subgroups.
Reference: John B. Fraleigh, _A First Course in Abstract Algebra_, Seventh edition, Pearson new international edition (Harlow: Pearson, 2014).
<!--ID: 1776962577516-->
END%%
