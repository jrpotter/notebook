...
A language is **undecidable** if no Turing machine can decide it. Proving undecidability is usually done by performing a [[reducibility|reduction]] on an undecidable language.
...
%%ANKI
Basic
What argument shows there must exist some undecidable languages?
Back: There are a countable number of TMs but an uncountable number of languages.
Reference: Michael Sipser, _Introduction to the Theory of Computation_, Third edition, international edition (Cengage Learning, 2013).
<!--ID: 1774544028225-->
END%%
