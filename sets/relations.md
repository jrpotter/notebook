...
A **relational structure** is a nonempty set $A$ and a collection of relations on $A$. A **binary relational structure** $\langle A, R \rangle$ is a nonempty set $A$ and a binary relation $R$ on $A$.

%%ANKI
Basic
What is a relational structure?
Back: A nonempty set $A$ together with a collection of relations acting on $A$.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1775160703263-->
END%%
...
%%ANKI
Basic
What is a binary relational structure?
Back: A pair $\langle A, R \rangle$ consisting of a set $A$ and a binary relation $R$ on $S$.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1751416133860-->
END%%
...
%%ANKI
Basic
What kind of mathematical entity is $A$ in binary relational structure $\langle A, R \rangle$?
Back: A set.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1751416133870-->
END%%
...
%%ANKI
Basic
What kind of mathematical entity is $R$ in binary relational structure $\langle A, R \rangle$?
...
%%ANKI
Basic
A binary relational structure is a tuple of how many elements?
Back: Two.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1751416133887-->
END%%
...
Back: A (binary) relational structure.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1751416316736-->
END%%
...
Basic
What is a poset?
Back: A binary relational structure $\langle P, \leq \rangle$ such that $\leq$ is a partial order on set $P$.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1751416427787-->
END%%
...
Let $\langle A, R \rangle$ and $\langle B, S \rangle$ be binary relational structures. An **isomorphism** from $\langle A, R \rangle$ onto $\langle B, S \rangle$ is a [[sets/functions#Injectivity|one-to-one]] [[functions|function]] $f$ from $A$ [[sets/functions#Surjectivity|onto]] $B$ satisfying: $$xRy \Leftrightarrow f(x) S f(y), \quad \text{for all } x, y \in A.$$
...
%%ANKI
Basic
How do we denote that relational structures $\langle A, R \rangle$ and $\langle B, S \rangle$ are isomorphic?
...
%%ANKI
Basic
Let $\langle A, R \rangle$ and $\langle B, S \rangle$ be binary relational structures. How is an isomorphism between them defined?
...
%%ANKI
Basic
What does the following denote between two binary relational structures? $$\langle A, R \rangle \cong \langle B, S \rangle$$
Back: $\langle A, R \rangle$ and $\langle B, S \rangle$ are isomorphic.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1756331535847-->
END%%
...
%%ANKI
Basic
Suppose binary relational structure $\langle A, R \rangle$ is isomorphic to $\langle B, S \rangle$. Are $A$ and $B$ equinumerous?
Back: Yes.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1756331535851-->
END%%
...
%%ANKI
Basic
Suppose $A$ and $B$ are equinumerous. Are binary relational structures $\langle A, R \rangle$ and $\langle B, S \rangle$ isomorphic?
Back: Not necessarily.
Reference: Herbert B. Enderton, *Elements of Set Theory* (New York: Academic Press, 1977).
<!--ID: 1756331535855-->
END%%
