...
A **function-class** $H$ is a class of ordered pairs that satisfies the definition of being a [[sets/functions|function]] except that it may not be a set. That is, for all $\langle x, y_1 \rangle \in H$, if $\langle x, y_2 \rangle \in H$, then it follows that $y_1 = y_2$.
