...
The **Cartesian square** of a set $A$ is the Cartesian product $A^2 = A \times A$. The **$n$-ary Cartesian power** of a set $A$, denoted $A^n$, is defined as $$\begin{align*} A^n & = A \times A \times \cdots \times A \\[1ex] & = \{ \langle a_1, \ldots, a_n \rangle \mid a_i \in A \text{ for every } i \in \{1, \ldots, n \}\}. \end{align*}$$
...
* _Wikipedia_. “Cartesian product.” April 22, 2025. [https://en.wikipedia.org/w/index.php?title=Cartesian_product](https://en.wikipedia.org/w/index.php?title=Cartesian_product&oldid=1286895522).
