...
A **Blinded** creature experiences the following effects:
...
A **Charmed** creature experiences the following effects:
...
A **Deafened** creature experiences the following effects:
...
A **Frightened** creature experiences the following effects:
...
A **Grappled** creature experiences the following effects:
...
An **Incapacitated** creature experiences the following effects:
...
An **Invisible** creature experiences the following effects:
...
A **Paralyzed** creature experiences the following effects:
...
A **Petrified** experiences the following effects:
...
A **Poisoned** creature experiences the following effects:
...
A **Prone** creature experiences the following effects:
...
A **Restrained** creature experiences the following effects:
...
A **Stunned** creature experiences the following effects:
...
An **Unconscious** creature experiences the following effects:
...
%%ANKI
Basic
Which two conditions include the *Automatic Critical Hits* effect?
Back: Paralyzed and Unconscious.
Reference: Crawford, Jeremy. _Dungeons & Dragons - Player’s Handbook_. Wizards of the Coast LLC, 2024.
<!--ID: 1772138028918-->
END%%
